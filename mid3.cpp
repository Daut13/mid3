...
int errorcnt = 0;
    ...
    cout << setw(10) << "mass" << setw(10) << "height" << setw(10) <<
        "ponderal" << setw(10) << "returned" << endl;
    cout << setw(10) << "----------"
        << setw(10) << "----------"
        << setw(10) << "----------"
        << setw(10) << "----------" << endl;

    for  (int i = 0; i < 478; i = i + 3) {
        //when the data is outside of the tolerance value
        if ((codes[i+2] - getPonderal(codes[i], codes[i+1])) > tolerance) {
            cout << setw(10) << codes[i] << setw(10) << codes[i+1] << setw(10)
                << codes[i+2] << setw(10) <<
                getPonderal(codes[i], codes[i+1]) << 
                " <----- outside of tolerance" << endl;
            errorcnt++;
        } 
        //else just output the data
            ...
            cout << setw(10) << codes[i] << setw(10) << codes[i+1] << setw(10)
                << codes[i+2] << setw(10) <<
                getPonderal(codes[i], codes[i+1]) << endl;
        }

    }   

    cout << endl << errorcnt << " errors found." << endl << "end-of-unit-test"
        << endl;
